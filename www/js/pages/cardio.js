  ...
  function _iniciarContador(){
    ...
    if(typeof DeviceMotionEvent !== "undefined" && typeof DeviceMotionEvent.requestPermission === "function"){
      DeviceMotionEvent.requestPermission().then(function(r){
        if(r === "granted"){
          var info = document.getElementById("sensor-info");
          if(info){ info.textContent = "✅ Sensor de movimiento activo"; info.style.color = "rgba(48,209,88,0.7)"; }
          activar();
        } else {
          window.mostrarToast && window.mostrarToast("⚠️ Permiso denegado. Ve a Ajustes → Safari → Movimiento y orientación.");
        }
