  ...
  window.db = {
    ...
    seedDemo: function(){
      ...
      var plan = {
        ...
        descripcion:"Santi, este plan está diseñado para disminuir grasa corporal manteniendo la masa muscular. 3 comidas principales con 5 opciones cada una para que siempre tengas variedad.",
        comidas:[
          { nombre:"Desayuno", hora:"07:00", descripcion:"Elige una opción. Cada una aporta entre 500-600 kcal.",
            opciones:[
          ...
          { nombre:"Comida", hora:"13:00", descripcion:"Comida principal. Elige una opción.",
            opciones:[
          ...
          { nombre:"Cena", hora:"19:30", descripcion:"Cena ligera rica en proteína.",
            opciones:[
