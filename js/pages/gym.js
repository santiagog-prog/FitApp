...
(function(){
  ...
  window.init_gym = function(){
    ...
    window.renderHeaderDetalle(gym.nombre || "Mi Gimnasio", function(){ window.irAPagina("inicio"); });

    if(!gym.activo){
      document.getElementById("page-gym").innerHTML = "<div class='estado-vacio'><h3>Sin gimnasio asociado</h3><p>Tu entrenador aún no asoció un gimnasio a la app.</p></div>";
      return;
    }
